...
public class CartController {
	...
	public String addToCart(HttpServletRequest request, Model model, @RequestParam("id") Long id,
		...
		if (sessionToken == null) {
			...
			shoppingCartService.addShoppingCartFirstTime(id, sessionToken, quantity,userid);
		} else {
			shoppingCartService.addToExistingShoppingCart(id, sessionToken, quantity,userid);
		}
		return "redirect:/";
	}
